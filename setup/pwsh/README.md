...
**Do not make any changes to the [`Microsoft.PowerShell_profile.ps1`](Microsoft.PowerShell_profile.ps1) file**, since it's hashed and automatically overwritten by any commits to this repository.
