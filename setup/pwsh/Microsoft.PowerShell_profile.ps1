...
############                               https://github.com/imrancio/scripts.git.                                  ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function Update-Profile {
    ...
    try {
        $url = "https://github.com/imrancio/scripts/raw/main/setup/powershell/Microsoft.PowerShell_profile.ps1"
...
function Get-Theme {
    if (Test-Path -Path $PROFILE.CurrentUserAllHosts -PathType leaf) {
        ...
        oh-my-posh init pwsh --config https://github.com/JanDeDobbeleer/oh-my-posh/raw/main/themes/night-owl.omp.json | Invoke-Expression
    }
}
...
gcam <message> - Adds all changes and commits with the specified message.
